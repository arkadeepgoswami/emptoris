...
import com.dicarta.webservices.services.contract.GetTermData;
...
//        String contractUuid = args[3];
        ...
        String internalPartyName="oo_name";
        getTermsTest(hostUrl, userId, password, contractUuid,internalPartyName);

    }

    public static void getTermsTest(String hostUrl, String userId, String password, String contractUuid,String internalPartyName) {
        ...
        try {
           ...
           //  Term termTest=new Term();
            // termTest.setLabel(internalPartyName);
             ...
             GetTermData termTest= new GetTermData();
             termTest.setTermName(internalPartyName);
             termTest.setContractReference(reference);
             //com.dicarta.webservices.services.contract.GetRequest request = new com.dicarta.webservices.services.contract.GetRequest();
             
             com.dicarta.webservices.services.contract.GetTermRequest request=new com.dicarta.webservices.services.contract.GetTermRequest();
        ...
        // GetResponse response = binding.get(request);
         GetTermResponse response = binding.getTerm(request);
